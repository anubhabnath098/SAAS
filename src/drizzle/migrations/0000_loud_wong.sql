...
CREATE TABLE "countrie" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "countrie_name_unique" UNIQUE("name"),
	CONSTRAINT "countrie_code_unique" UNIQUE("code")
);
--> statement-breakpoint
...
ALTER TABLE "countrie" ADD CONSTRAINT "countrie_country_group_id_country_groups_id_fk" FOREIGN KEY ("country_group_id") REFERENCES "public"."country_groups"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "product_views" ADD CONSTRAINT "product_views_country_id_countrie_id_fk" FOREIGN KEY ("country_id") REFERENCES "public"."countrie"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
