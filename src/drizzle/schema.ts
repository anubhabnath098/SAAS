...
export const productViewsRelations = relations(ProductViewTable, ({one})=>({
    product: one(ProductTable,{
...
export const UserSubscriptionTable = pgTable("user_subscription",{
    ...
    createdAt,
    updatedAt,
}, table=>({clerkUserIdIndex: index("user_subscription.clerk_user_id_index").on(
    table.clerkUserId
),
